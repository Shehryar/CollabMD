...
class CodeFenceLabelWidget extends WidgetType {
  ...
  toDOM() {
    ...
    label.textContent = this.info.trim() || 'code'
    return label
  }

  eq(other: CodeFenceLabelWidget) {
...
function buildDecorations(state: EditorState): DecorationSet {
  ...
  for (const block of findCodeFenceBlocks(state)) {
    ...
    const openingLine = state.doc.lineAt(block.firstLineFrom)
    const closingLine = state.doc.line(block.lastLineNumber)

    decorations.push(
      Decoration.line({ class: 'cm-md-codefence-line cm-md-codefence-line-label' }).range(
        openingLine.from,
      ),
    )
    decorations.push(
      Decoration.replace({
        widget: new CodeFenceLabelWidget(block.info),
      }).range(block.firstLineFrom, block.firstLineTo),
    )

    for (
      let lineNumber = openingLine.number + 1;
      lineNumber < block.lastLineNumber;
      lineNumber++
    ) {
      const line = state.doc.line(lineNumber)
      const lineClasses = ['cm-md-codefence-line']
      if (lineNumber === openingLine.number + 1) lineClasses.push('cm-md-codefence-line-first')
      if (lineNumber === block.lastLineNumber - 1) lineClasses.push('cm-md-codefence-line-last')

      decorations.push(Decoration.line({ class: lineClasses.join(' ') }).range(line.from))
      if (line.length > 0) {
        decorations.push(Decoration.mark({ class: 'cm-md-codefence-code' }).range(line.from, line.to))
      }
    }

    decorations.push(
      Decoration.line({ class: 'cm-md-codefence-line cm-md-codefence-line-close' }).range(
        closingLine.from,
      ),
    )
...
export const markdownPreviewTheme = EditorView.theme({
  ...
  '.cm-md-h3': {
    ...
    fontWeight: '600',
    lineHeight: '1.4',
    color: 'var(--editor-md-heading-alt)',
    fontFamily: 'system-ui, -apple-system, sans-serif',
  },
  '.cm-md-h4': {
    fontSize: '1.1em',
  ...
  '.cm-md-codefence-line-first': {
    paddingTop: '4px',
  },
  '.cm-md-codefence-line-last': {
    paddingBottom: '12px',
  },
  '.cm-md-codefence-line-close': {
    paddingTop: '0',
    paddingBottom: '10px',
  ...
  '.cm-md-link': {
    ...
    textDecorationColor: 'var(--editor-md-link-underline)',
    cursor: 'pointer',
    '&:hover': {
      textDecorationColor: 'var(--editor-md-link)',
    },
  },
  '.cm-md-bullet': {
    color: 'var(--editor-muted)',
  ...
  '.cm-md-marker': {
    opacity: '0.5',
    color: 'var(--editor-md-marker)',
  },
  '.cm-md-hr': {
    border: 'none',
    borderTop: '2px solid var(--editor-border)',
    margin: '8px 0',
  },
  '.cm-md-blockquote': {
    borderLeft: '3px solid var(--editor-md-quote-border)',
    paddingLeft: '12px',
    color: 'var(--editor-md-quote-text)',
  },
  '.cm-md-math': {
    verticalAlign: 'middle',
  },
  ...
  '.cm-md-table': {
    ...
    fontSize: '0.95em',
    backgroundColor: 'var(--editor-md-table-bg)',
    color: 'var(--editor-md-table-text)',
    border: '1px solid var(--editor-md-table-border)',
  },
  '.cm-md-table th': {
    backgroundColor: 'var(--editor-md-table-header-bg)',
    fontWeight: '600',
    color: 'var(--editor-md-table-text)',
  },
  '.cm-md-table th, .cm-md-table td': {
    borderBottom: '1px solid var(--editor-md-table-border)',
    padding: '8px 10px',
    verticalAlign: 'top',
  },
  ...
  '.cm-md-mermaid': {
    ...
    margin: '12px 0',
    padding: '12px',
    backgroundColor: 'var(--editor-mermaid-bg)',
    border: '1px solid var(--editor-mermaid-border)',
    borderRadius: '8px',
    overflowX: 'auto',
  },
  '.cm-md-mermaid-svg': {
