  ...
  return (
    <aside className="flex h-full w-[320px] shrink-0 flex-col border-l border-border bg-bg-subtle">
      <div className="flex items-center justify-between border-b border-border px-3 py-2.5">
        <div>
          <h2 className="font-mono text-[12px] font-semibold text-fg">Comments</h2>
          <p className="text-[11px] text-fg-muted">{unresolvedCount} open</p>
        </div>
        <button
          type="button"
      ...
      <div className="flex items-center justify-between border-b border-border px-3 py-2">
        ...
        <span className="font-mono text-[10px] text-fg-muted">{comments.length} total</span>
      </div>
