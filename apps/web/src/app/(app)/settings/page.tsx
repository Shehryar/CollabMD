    ...
    <div className="mx-auto w-full max-w-3xl px-4 py-8 sm:px-6">
      <div className="rounded border border-border bg-bg p-5">
        <div className="flex flex-wrap items-start justify-between gap-3">
          <div>
            ...
            <p className="mt-2 max-w-xl text-sm text-fg-secondary">
              Manage your personal CollabMD preferences, including theme and email notifications.
            </p>
          </div>
        ...
        <div className="mt-5 space-y-4">
          ...
          <div>
            <h2 className="mb-3 font-mono text-[12px] font-medium text-fg">Email notifications</h2>
