    ...
    return (
      <div className="flex min-h-screen items-center justify-center bg-bg-subtle">
        <div className="w-full max-w-sm rounded-lg border border-border bg-bg p-8 text-center shadow">
          ...
          <h2 className="mb-2 font-mono text-[18px] font-semibold tracking-[-0.02em] text-fg">
            Check your email
          </h2>
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-bg-subtle">
      <div className="w-full max-w-sm rounded-lg border border-border bg-bg p-8 shadow">
        <h1 className="mb-1 font-mono text-[18px] font-semibold tracking-[-0.02em] text-fg">
          Sign in to CollabMD
        </h1>
        <p className="mb-6 font-sans text-sm text-fg-secondary">Collaborative markdown editing</p>

        {error && (
          <div className="mb-4 rounded bg-red-subtle px-3 py-2 text-sm text-red">{error}</div>
        )}
        ...
        <form onSubmit={handleMagicLink} className="space-y-3">
          <div>
            <label
              htmlFor="email"
              className="mb-1 block font-mono text-[11px] font-medium uppercase tracking-[0.02em] text-fg-secondary"
            >
              Email
            </label>
            <input
        ...
        <div className="space-y-2">
          ...
          >
            ...
            {socialLoading === 'github' ? 'Redirecting...' : 'Sign in with GitHub'}
          </button>
        </div>
