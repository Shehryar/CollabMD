...
export const typeScale = {
  ...
  label: { family: 'mono', size: '11px', weight: 500, letterSpacing: '0.02em', textTransform: 'uppercase' as const },
  sectionHeader: { family: 'mono', size: '10.5px', weight: 500, letterSpacing: '0.06em', textTransform: 'uppercase' as const },
